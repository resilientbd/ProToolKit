...
import com.example.protoolkit.util.QrCodeUtils;
...
public class QrScannerViewModel extends BaseViewModel {
    ...
    private final MutableLiveData<Integer> statusMessageRes = new MutableLiveData<>(com.example.protoolkit.R.string.qr_scanner_status_idle);
    ...
    public void updatePermission(boolean granted) {
        ...
        if (!granted) {
            ...
            statusMessageRes.setValue(com.example.protoolkit.R.string.qr_scanner_permission_required);
        } else {
            statusMessageRes.setValue(com.example.protoolkit.R.string.qr_scanner_ready_message);
        }
    }
    ...
    public void startScanning() {
        ...
        statusMessageRes.setValue(com.example.protoolkit.R.string.qr_scanner_placeholder_active);
    }

    public void stopScanning() {
        scanningActive.setValue(false);
        statusMessageRes.setValue(com.example.protoolkit.R.string.qr_scanner_paused_message);
    }
    ...
    public void handleScanResult(String result) {
        ...
        statusMessageRes.setValue(com.example.protoolkit.R.string.qr_scanner_status_idle);
